...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'icon iconfont icon-icon-test4 animated fadeOutDown'])
Z([3,'color:#09BB07;font-size:100px;'])
...
var x=['./pages/index/index.wxml','./pages/mine/mine.wxml','./pages/place_order/place_order.wxml','./pages/test/test.wxml'];d_[x[0]]={}
...
var fE=_mz(z,'navigator',['hoverClass',4,'url',1],[],e,s,gg)
var cF=_n('text')
...
var bO=_mz(z,'view',['class',13,'hoverClass',1],[],aL,lK,gg)
var oP=_n('view')
_rz(z,oP,'class',15,aL,lK,gg)
var xQ=_mz(z,'image',['class',16,'src',1],[],aL,lK,gg)
_(oP,xQ)
var oR=_n('view')
_rz(z,oR,'class',18,aL,lK,gg)
var fS=_n('view')
_rz(z,fS,'class',19,aL,lK,gg)
var cT=_oz(z,20,aL,lK,gg)
_(fS,cT)
_(oR,fS)
var hU=_n('view')
_rz(z,hU,'class',21,aL,lK,gg)
var oV=_oz(z,22,aL,lK,gg)
_(hU,oV)
_(oR,hU)
_(oP,oR)
_(bO,oP)
...
__wxAppCode__['pages/place_order/place_order.wxss']=undefined;    
__wxAppCode__['pages/place_order/place_order.wxml']=$gwx('./pages/place_order/place_order.wxml');
